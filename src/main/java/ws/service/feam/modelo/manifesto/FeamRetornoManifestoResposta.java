...
public class FeamRetornoManifestoResposta {

	private Integer manifestoCodigo;
	private String seuCodigoReferencia;
	...
	private List<ItemRetornoManifestoJSON> itemManifestoJSONs;
	...
	public String getSeuCodigoReferencia() {
		return seuCodigoReferencia;
	}

	public void setSeuCodigoReferencia(String seuCodigoReferencia) {
	...
	public List<ItemRetornoManifestoJSON> getItemManifestoJSONs() {
		return itemManifestoJSONs;
	}

	public void setItemManifestoJSONs(List<ItemRetornoManifestoJSON> itemManifestoJSONs) {
